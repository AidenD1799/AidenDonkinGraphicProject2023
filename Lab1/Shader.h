...
public:
	...
	void initialiseShader(const std::string& vertFile, const std::string& fragFile);
	void initialiseGeoShader(const std::string& vertFile, const std::string& fragFile, const std::string& geoFile);
